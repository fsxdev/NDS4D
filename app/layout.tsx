...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'NDS4D - Neat Dark Styling 4 DEVS',
    description: 'A collection of accessible, reusable UI components with dark styling for developers.',
    url: 'https://nds4d.vercel.app',
    siteName: 'NDS4D',
    images: [{ url: 'https://nds4d.vercel.app/favicon-128x128.png' }],
    type: 'website',
  },
  icons: {
    apple: [
